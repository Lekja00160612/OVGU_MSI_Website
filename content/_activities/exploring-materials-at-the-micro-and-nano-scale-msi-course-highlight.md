...
This course introduces MSI students to the fundamental techniques used to analyze the structure and properties of materials, helping them understand how materials behave from the micro- to nano-scale.

During the course, students explored important analytical methods widely used in modern materials research and industry, including:

	- Scanning Electron Microscopy (SEM) for microstructural imaging
...
Through international teaching collaboration and advanced scientific content, the MSI program continues to provide students with strong research-oriented training and global academic exposure.

Courses like Materials Characterization equip MSI students with the analytical tools needed to understand and engineer advanced materials for future technologies.
