...
useSeoMeta({
  ...
  description: () => page.value?.meta?.description || 'Learn about admission requirements, English/IELTS criteria, direct entry, and bridging pathways for the Master of Science in Materials Science and Innovation program at VGU.',
  ogDescription: () => page.value?.meta?.description || 'Learn about admission requirements, English/IELTS criteria, direct entry, and bridging pathways for the Master of Science in Materials Science and Innovation program at VGU.',
})
</script>
